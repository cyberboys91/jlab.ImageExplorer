package jlab.ImageExplorer.Activity.Fragment;
...
import static jlab.ImageExplorer.Service.TaskFileSystemChangeService.TIME_INTERVAL_TASK_REFRESH;
...
public class DeleteFragment extends DialogFragment {
    ...
    private static Interfaces.IFinishListener mfinishListener = new Interfaces.IFinishListener() {
        @Override
    ...
    public void setFinishListener(Interfaces.IFinishListener finishListener)
    {
        DeleteFragment.mfinishListener = finishListener;
    }
        ...
        deleteService.setFinishListener(new Interfaces.IFinishListener() {
            ...
            public void refresh(final boolean successfully) {
                try {
                    ...
                    mfinishListener.refresh(successfully);
                } catch (Exception exp) {
                    exp.printStackTrace();
                } finally {

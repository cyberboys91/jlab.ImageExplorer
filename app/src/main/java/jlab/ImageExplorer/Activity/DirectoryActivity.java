...
import jlab.ImageExplorer.View.*;
import android.widget.ProgressBar;
import android.widget.LinearLayout;
import android.view.LayoutInflater;
import android.util.DisplayMetrics;
import android.app.DownloadManager;
import jlab.ImageExplorer.Resource.*;
...
import jlab.ImageExplorer.DownloadImageTask;
...
import jlab.ImageExplorer.Activity.Fragment.*;
...
public class DirectoryActivity extends AppCompatActivity
    ...
    public boolean onResourceLongClick(final Resource resource, final int position) {
        CharSequence[] items = resource.isDir()
                ...
                getString(R.string.set_image_as), getString(R.string.rename), getString(R.string.delete),
                getString(R.string.details)};

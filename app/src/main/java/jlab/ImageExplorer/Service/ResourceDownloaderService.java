package jlab.ImageExplorer.Service;
...
public class ResourceDownloaderService extends Service {
    ...
    private final static int NOTIFICATION_ID = 910129023, TIME_INTERVAL_NOT_DOWNLOAD = 1000;
    ...
    private static Intent getServiceIntent() {
        return new Intent().setComponent(new ComponentName("jlab.VideoPlayer",
                "jlab.VideoPlayer.Service.ResourceDownloaderService"));
    }
